...
export const MIN_TOPIC_VISUAL = Number(process.env.MIN_TOPIC_VISUAL ?? 0.7);

/**
 * Can this STORY be filmed at all? Probes the topic's own visualSubjects against the stock
